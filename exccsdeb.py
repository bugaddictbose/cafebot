...
def fram2():
    def dessert():
        ...
        swt = Button(food,text="PASTREY", command = sweet)
        swt.grid(row=1,column=1)
        ck1 = Button(food, text="CUP CAKE", command = cake)
        ck1.grid(row=2,column=0)
        swt1 = Button(food,text="RASOGOLLA", command = sweet)
        swt1.grid(row=2,column=1)
        ck2 = Button(food, text="PANTOA", command = cake)
        ck2.grid(row=3,column=0)
        swt2 = Button(food,text="PIE CAKE", command = sweet)
        swt2.grid(row=3,column=1)
    def snack():
        def burger():
            foodv = "burger"
            pay('burger')            
        ...
        brg1 = Button(food, text="KARARE", command = burger)
        brg1.grid(row=2,column=0)
        chp1 = Button(food, text="PAKORA", command = chips)
        chp1.grid(row=2,column=1)
        chp2 = Button(food, text="SPRING ROLL", command = chips)
        chp2.grid(row=3,column=1)
        brg2 = Button(food, text="SANDWICH", command = burger)
        brg2.grid(row=3,column=0)
